...
export default function Wordle() {
            ...
            if(!words.current.includes(word.current)) {
                ...
                */
                ...
                for(let i = 0; i < 5; i++) {
                    ...
                    // Rotate animation
                    element.children[i].classList.add(styles.rotate);
                    ...
                    if(word.current[i] === theWord.current[i]) { // Check if current letter of user's word is in the right place
                        ...
                        element.children[i].classList.add(styles.correct);
                        
                        // Remove the incorrect and partial style if they exist and set the background of the correct keyboard letter
                        keyboardLetter.remove(styles.incorrect);
                        keyboardLetter.remove(styles.partial);
                        keyboardLetter.add(styles.correct);
                        ...
                        element.children[i].classList.add(styles.partial);
                        ...
                        if(keyboardLetter.length === 1) {
                            keyboardLetter.add(styles.partial);
                        }
                        ...
                        element.children[i].classList.add(styles.incorrect);
                        ...
                        if(keyboardLetter.length === 1 && !correctLetters.includes(word.current[i])) {
                            keyboardLetter.add(styles.incorrect);
                        }
                    }
                ...
                if(correct === 5) {
                    ...
                    if(letter.current === "f") {
                        ...
                        let lost = document.getElementById(styles.lost);

                        await timer(300);
                        lost.classList.remove(styles.hidden);
                        ...
                        //lost.style.cssText = "margin-top: 3.1em;";
                        lost.classList.add(styles.show);
    ...
    async function clearBoard() {
        ...
        if(state.current === "lost") {
            document.getElementById(styles.lost).classList = document.getElementById(styles.lost).classList[0];
            await timer(400);
            document.getElementById(styles.lost).classList.add(styles.hidden);
        }
        ...
        for(let x = letters.indexOf(letter.current); x > -1; x--) {
            ...
            for(let i = 4; i > -1; i--) {
                ...
                element.children[i].classList.add(styles.rotateBack);
    ...
    return <>
        ...
        <div className={styles.main}>
            ...
            <div className={styles.guessContainer}>
                <div id="row-a" className={styles.guessRow}>
                    <div className={styles.guessLetter}>
                        <h1 id="a0"></h1>
                    </div>
                    <div className={styles.guessLetter}>
                        <h1 id="a1"></h1>
                ...
                <div id="row-b" className={styles.guessRow}>
                    <div className={styles.guessLetter}>
                        <h1 id="b0"></h1>
                    </div>
                    <div className={styles.guessLetter}>
                ...
                <div id="row-c" className={styles.guessRow}>
                    <div className={styles.guessLetter}>
                        <h1 id="c0"></h1>
                    </div>
                    <div className={styles.guessLetter}>
                ...
                <div id="row-d" className={styles.guessRow}>
                    <div className={styles.guessLetter}>
                        <h1 id="d0"></h1>
                    </div>
                    <div className={styles.guessLetter}>
                ...
                <div id="row-e" className={styles.guessRow}>
                    <div className={styles.guessLetter}>
                        <h1 id="e0"></h1>
                    </div>
                    <div className={styles.guessLetter}>
                ...
                <div id="row-f" className={styles.guessRow}>
                    <div className={styles.guessLetter}>
                        <h1 id="f0"></h1>
                    </div>
                    <div className={styles.guessLetter}>
                ...
                <div id={styles.lost} className={styles.guessRow + " " + styles.hidden}>
                    <div className={styles.guessLetter + " " + styles.correct}>
                        <h1 id="l0"></h1>
                    </div>
                    <div className={styles.guessLetter + " " + styles.correct}>
                        <h1 id="l1"></h1>
            ...
            <div className={styles.keyboard}>
                <div className={styles.keyRow}>
                    <div className={styles.key + " " + styles.scoreKey}>
                        <h3>SCORE: {score.current} / {attempts.current}</h3>
                    </div>
                    <div className={styles.key + " " + styles.restartKey} onClick={() => restartGame()}>
                        <h3>PLAY AGAIN</h3>
                    </div>
                </div>
                <div className={styles.keyRow}>
                    <div id="q" className={styles.key} onClick={() => letterKey("q")}>
                        <h3>Q</h3>
                    </div>
                    <div id="w" className={styles.key} onClick={() => letterKey("w")}>
                        <h3>W</h3>
                    </div>
                    <div id="e" className={styles.key} onClick={() => letterKey("e")}>
                        <h3>E</h3>
                    </div>
                    <div id="r" className={styles.key} onClick={() => letterKey("r")}>
                        <h3>R</h3>
                    </div>
                    <div id="t" className={styles.key} onClick={() => letterKey("t")}>
                        <h3>T</h3>
                    </div>
                    <div id="y" className={styles.key} onClick={() => letterKey("y")}>
                        <h3>Y</h3>
                    </div>
                    <div id="u" className={styles.key} onClick={() => letterKey("u")}>
                        <h3>U</h3>
                    </div>
                    <div id="i" className={styles.key} onClick={() => letterKey("i")}>
                        <h3>I</h3>
                    </div>
                    <div id="o" className={styles.key} onClick={() => letterKey("o")}>
                        <h3>O</h3>
                    </div>
                    <div id="p" className={styles.key} onClick={() => letterKey("p")}>
                        <h3>P</h3>
                    </div>
                </div>

                <div className={styles.keyRow}>
                    <div id="a" className={styles.key} onClick={() => letterKey("a")}>
                        <h3>A</h3>
                    </div>
                    <div id="s" className={styles.key} onClick={() => letterKey("s")}>
                        <h3>S</h3>
                    </div>
                    <div id="d" className={styles.key} onClick={() => letterKey("d")}>
                        <h3>D</h3>
                    </div>
                    <div id="f" className={styles.key} onClick={() => letterKey("f")}>
                        <h3>F</h3>
                    </div>
                    <div id="g" className={styles.key} onClick={() => letterKey("g")}>
                        <h3>G</h3>
                    </div>
                    <div id="h" className={styles.key} onClick={() => letterKey("h")}>
                        <h3>H</h3>
                    </div>
                    <div id="j" className={styles.key} onClick={() => letterKey("j")}>
                        <h3>J</h3>
                    </div>
                    <div id="k" className={styles.key} onClick={() => letterKey("k")}>
                        <h3>K</h3>
                    </div>
                    <div id="l" className={styles.key} onClick={() => letterKey("l")}>
                        <h3>L</h3>
                    </div>
                </div>

                <div className={styles.keyRow}>
                    <div className={styles.key + " " + styles.bigKey} onClick={() => enterKey()}>
                        <h4>ENTER</h4>
                    </div>
                    <div id="z" className={styles.key} onClick={() => letterKey("z")}>
                        <h3>Z</h3>
                    </div>
                    <div id="x" className={styles.key} onClick={() => letterKey("x")}>
                        <h3>X</h3>
                    </div>
                    <div id="c" className={styles.key} onClick={() => letterKey("c")}>
                        <h3>C</h3>
                    </div>
                    <div id="v" className={styles.key} onClick={() => letterKey("v")}>
                        <h3>V</h3>
                    </div>
                    <div id="b" className={styles.key} onClick={() => letterKey("b")}>
                        <h3>B</h3>
                    </div>
                    <div id="n" className={styles.key} onClick={() => letterKey("n")}>
                        <h3>N</h3>
                    </div>
                    <div id="m" className={styles.key} onClick={() => letterKey("m")}>
                        <h3>M</h3>
                    </div>
                    <div className={styles.key + " " + styles.bigKey} onClick={() => deleteKey()}>
                        <i className={styles.icon + " fa-solid fa-delete-left"}></i>
                    </div>
                </div>
            </div>
        </div>
